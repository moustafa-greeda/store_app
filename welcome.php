...
if (!isset($_SESSION['userName'])) {
    header("Location: ./user_erae/login.php");
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        /* .background , input[submit] , button {
...
<body>
    <div class="parent container_fluid p-0 mer-0">
        <nav class="navbar navbar-expand-lg navbar-light bg-dark text-light" class="background">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                if(isset($_SESSION['userName'])){
                    ...
                    <a class='nav-link text-light' href='user_erae/profile.php'>myAccount</a>
                    </li>";
                }else{
                    echo "<li class='nav-item'>
